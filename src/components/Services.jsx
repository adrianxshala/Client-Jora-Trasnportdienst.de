    ...
    <section id="services" ref={sectionRef} className="relative py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <ServiceBox icon={<Globe className="h-12 w-12 text-cyan-500 mb-4" />} title="Internationaler Transport" description="Transportdienste in ganz Europa mit unserer modernen Flotte." />
          <ServiceBox icon={<Truck className="h-12 w-12 text-purple-500 mb-4" />} title="Inlandstransport" description="Umfassende Abdeckung des albanischen Territoriums mit schnellem und sicherem Service." />
          <ServiceBox icon={<Package className="h-12 w-12 text-pink-500 mb-4" />} title="Logistik" description="Integrierte Logistiklösungen für Ihr Unternehmen." />
          <ServiceBox icon={<Warehouse className="h-12 w-12 text-green-500 mb-4" />} title="Lagerhaltung" description="Moderne Lagerhäuser mit hoher Sicherheit und professioneller Verwaltung." />
        </div>
      </div>
    </section>
  );
