  ...
  return (
    <section className="relative py-20">
      <div
        ...
        loading="lazy"
        aria-label="Hintergrundbild für Transportdienst Jora"
      />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mt-8">
          <motion.a
            ...
            href="#contact"
            title="Angebot für Transportdienst Jora anfordern"
            aria-label="Angebot für Transportdienst Jora anfordern"
